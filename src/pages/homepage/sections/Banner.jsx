...
const Banner = () => {
  ...
  return (
    <div className="w-[100%]  h-[270px] relative xsm:text-xl pt-[72px] bg-black grid place-items-center">
      <div className="absolute top-0 z-[10000] w-full h-auto text-center mt-2">
      ...
      {/* {backgroundImg && (
        <div className="absolute top-0 left-0 h-full overflow-hidden bg-gradient-to-r from-cyan-500 to-blue-500">
